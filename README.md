...
|---------|------|---------|--------|-------|----------|
| aero | [aerogo/aero](https://github.com/aerogo/aero) | ![Tag](https://img.shields.io/github/tag/aerogo/aero.svg) | [![Report][report-image-aero]][report-url-aero] | [![Tests][tests-image-aero]][tests-url-aero] | [![Coverage][codecov-image-aero]][codecov-url-aero] |
| api | [aerogo/api](https://github.com/aerogo/api) | ![Tag](https://img.shields.io/github/tag/aerogo/api.svg) | [![Report][report-image-api]][report-url-api] | [![Tests][tests-image-api]][tests-url-api] | [![Coverage][codecov-image-api]][codecov-url-api] |
| certificate | [aerogo/certificate](https://github.com/aerogo/certificate) | ![Tag](https://img.shields.io/github/tag/aerogo/certificate.svg) | [![Report][report-image-certificate]][report-url-certificate] | [![Tests][tests-image-certificate]][tests-url-certificate] | [![Coverage][codecov-image-certificate]][codecov-url-certificate] |
| cluster | [aerogo/cluster](https://github.com/aerogo/cluster) | ![Tag](https://img.shields.io/github/tag/aerogo/cluster.svg) | [![Report][report-image-cluster]][report-url-cluster] | [![Tests][tests-image-cluster]][tests-url-cluster] | [![Coverage][codecov-image-cluster]][codecov-url-cluster] |
| codetree | [aerogo/codetree](https://github.com/aerogo/codetree) | ![Tag](https://img.shields.io/github/tag/aerogo/codetree.svg) | [![Report][report-image-codetree]][report-url-codetree] | [![Tests][tests-image-codetree]][tests-url-codetree] | [![Coverage][codecov-image-codetree]][codecov-url-codetree] |
...
| log | [aerogo/log](https://github.com/aerogo/log) | ![Tag](https://img.shields.io/github/tag/aerogo/log.svg) | [![Report][report-image-log]][report-url-log] | [![Tests][tests-image-log]][tests-url-log] | [![Coverage][codecov-image-log]][codecov-url-log] |
| markdown | [aerogo/markdown](https://github.com/aerogo/markdown) | ![Tag](https://img.shields.io/github/tag/aerogo/markdown.svg) | [![Report][report-image-markdown]][report-url-markdown] | [![Tests][tests-image-markdown]][tests-url-markdown] | [![Coverage][codecov-image-markdown]][codecov-url-markdown] |
| mirror | [aerogo/mirror](https://github.com/aerogo/mirror) | ![Tag](https://img.shields.io/github/tag/aerogo/mirror.svg) | [![Report][report-image-mirror]][report-url-mirror] | [![Tests][tests-image-mirror]][tests-url-mirror] | [![Coverage][codecov-image-mirror]][codecov-url-mirror] |
| nano | [aerogo/nano](https://github.com/aerogo/nano) | ![Tag](https://img.shields.io/github/tag/aerogo/nano.svg) | [![Report][report-image-nano]][report-url-nano] | [![Tests][tests-image-nano]][tests-url-nano] | [![Coverage][codecov-image-nano]][codecov-url-nano] |
| packet | [aerogo/packet](https://github.com/aerogo/packet) | ![Tag](https://img.shields.io/github/tag/aerogo/packet.svg) | [![Report][report-image-packet]][report-url-packet] | [![Tests][tests-image-packet]][tests-url-packet] | [![Coverage][codecov-image-packet]][codecov-url-packet] |
| pixy | [aerogo/pixy](https://github.com/aerogo/pixy) | ![Tag](https://img.shields.io/github/tag/aerogo/pixy.svg) | [![Report][report-image-pixy]][report-url-pixy] | [![Tests][tests-image-pixy]][tests-url-pixy] | [![Coverage][codecov-image-pixy]][codecov-url-pixy] |
| scarlet | [aerogo/scarlet](https://github.com/aerogo/scarlet) | ![Tag](https://img.shields.io/github/tag/aerogo/scarlet.svg) | [![Report][report-image-scarlet]][report-url-scarlet] | [![Tests][tests-image-scarlet]][tests-url-scarlet] | [![Coverage][codecov-image-scarlet]][codecov-url-scarlet] |
| session | [aerogo/session](https://github.com/aerogo/session) | ![Tag](https://img.shields.io/github/tag/aerogo/session.svg) | [![Report][report-image-session]][report-url-session] | [![Tests][tests-image-session]][tests-url-session] | [![Coverage][codecov-image-session]][codecov-url-session] |
| memstore | [aerogo/session-store-memory](https://github.com/aerogo/session-store-memory) | ![Tag](https://img.shields.io/github/tag/aerogo/session-store-memory.svg) | [![Report][report-image-memstore]][report-url-memstore] | [![Tests][tests-image-memstore]][tests-url-memstore] | [![Coverage][codecov-image-memstore]][codecov-url-memstore] |
...
| stringutils | [akyoto/stringutils](https://github.com/akyoto/stringutils) | ![Tag](https://img.shields.io/github/tag/akyoto/stringutils.svg) | [![Report][report-image-stringutils]][report-url-stringutils] | [![Tests][tests-image-stringutils]][tests-url-stringutils] | [![Coverage][codecov-image-stringutils]][codecov-url-stringutils] |
| webpush | [akyoto/webpush-go](https://github.com/akyoto/webpush-go) | ![Tag](https://img.shields.io/github/tag/akyoto/webpush-go.svg) | [![Report][report-image-webpush]][report-url-webpush] | [![Tests][tests-image-webpush]][tests-url-webpush] | [![Coverage][codecov-image-webpush]][codecov-url-webpush] |
| anilist | [animenotifier/anilist](https://github.com/animenotifier/anilist) | ![Tag](https://img.shields.io/github/tag/animenotifier/anilist.svg) | [![Report][report-image-anilist]][report-url-anilist] | [![Tests][tests-image-anilist]][tests-url-anilist] | [![Coverage][codecov-image-anilist]][codecov-url-anilist] |
| arn | [animenotifier/arn](https://github.com/animenotifier/arn) | ![Tag](https://img.shields.io/github/tag/animenotifier/arn.svg) | [![Report][report-image-arn]][report-url-arn] | [![Tests][tests-image-arn]][tests-url-arn] | [![Coverage][codecov-image-arn]][codecov-url-arn] |
| ffxiv | [animenotifier/ffxiv](https://github.com/animenotifier/ffxiv) | ![Tag](https://img.shields.io/github/tag/animenotifier/ffxiv.svg) | [![Report][report-image-ffxiv]][report-url-ffxiv] | [![Tests][tests-image-ffxiv]][tests-url-ffxiv] | [![Coverage][codecov-image-ffxiv]][codecov-url-ffxiv] |
| japanese | [animenotifier/japanese](https://github.com/animenotifier/japanese) | ![Tag](https://img.shields.io/github/tag/animenotifier/japanese.svg) | [![Report][report-image-japanese]][report-url-japanese] | [![Tests][tests-image-japanese]][tests-url-japanese] | [![Coverage][codecov-image-japanese]][codecov-url-japanese] |
| kitsu | [animenotifier/kitsu](https://github.com/animenotifier/kitsu) | ![Tag](https://img.shields.io/github/tag/animenotifier/kitsu.svg) | [![Report][report-image-kitsu]][report-url-kitsu] | [![Tests][tests-image-kitsu]][tests-url-kitsu] | [![Coverage][codecov-image-kitsu]][codecov-url-kitsu] |
| mal | [animenotifier/mal](https://github.com/animenotifier/mal) | ![Tag](https://img.shields.io/github/tag/animenotifier/mal.svg) | [![Report][report-image-mal]][report-url-mal] | [![Tests][tests-image-mal]][tests-url-mal] | [![Coverage][codecov-image-mal]][codecov-url-mal] |
| osu | [animenotifier/osu](https://github.com/animenotifier/osu) | ![Tag](https://img.shields.io/github/tag/animenotifier/osu.svg) | [![Report][report-image-osu]][report-url-osu] | [![Tests][tests-image-osu]][tests-url-osu] | [![Coverage][codecov-image-osu]][codecov-url-osu] |
| overwatch | [animenotifier/overwatch](https://github.com/animenotifier/overwatch) | ![Tag](https://img.shields.io/github/tag/animenotifier/overwatch.svg) | [![Report][report-image-overwatch]][report-url-overwatch] | [![Tests][tests-image-overwatch]][tests-url-overwatch] | [![Coverage][codecov-image-overwatch]][codecov-url-overwatch] |
| shoboi | [animenotifier/shoboi](https://github.com/animenotifier/shoboi) | ![Tag](https://img.shields.io/github/tag/animenotifier/shoboi.svg) | [![Report][report-image-shoboi]][report-url-shoboi] | [![Tests][tests-image-shoboi]][tests-url-shoboi] | [![Coverage][codecov-image-shoboi]][codecov-url-shoboi] |
| twist | [animenotifier/twist](https://github.com/animenotifier/twist) | ![Tag](https://img.shields.io/github/tag/animenotifier/twist.svg) | [![Report][report-image-twist]][report-url-twist] | [![Tests][tests-image-twist]][tests-url-twist] | [![Coverage][codecov-image-twist]][codecov-url-twist] |
